            ...
            <div className="category-content">
              <div className="media">
                <a href="#" className="media-left">
                  <img src="assets/images/placeholder.jpg" className="img-circle img-sm" alt="" /></a>
          ...
          <div className="sidebar-category sidebar-category-visible">
            <div className="category-content no-padding">
              <ul className="navigation navigation-main navigation-accordion">
                ...
                <li><a href="changelog.html"><i className="icon-list-unordered"></i> <span>Changelog <span className="label bg-blue-400">1.6</span></span></a></li>
                <li><a href="../../RTL/default/index.html"><i className="icon-width"></i> <span>RTL version</span></a></li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li><a href="appearance_helpers.html">Helper classNamees</a></li>
                ...
                <li>
                  <a href="#"><i className="icon-grid6"></i> <span>General pages</span></a>
                  <ul>
                    ...
                    <li>
                      <a href="#">Blog</a>
                      <ul>
                        <li><a href="blog_classNameic_v.html">classNameic vertical</a></li>
                        <li><a href="blog_classNameic_h.html">classNameic horizontal</a></li>
                ...
                <li>
                  <a href="#"><i className="icon-wrench3"></i> <span>Service pages</span></a>
                  <ul>
                ...
                <li>
                  <a href="#"><i className="icon-cube3"></i> <span>Application pages</span></a>
                  <ul>
                    <li>
